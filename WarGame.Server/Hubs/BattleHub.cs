...
public class BattleHub : Hub
{
    ...
    private static string CheckTurn(string username)
    {
        var player = PlayersList.GetPlayer(username);
    ...
    private static bool CheckAllCarsState(List<Car> cars)
    {
        foreach (var car in cars)
        {
            foreach (var coord in car.Coordinates)
    ...
    private static bool CheckCollision(int coordX, int coordY, string username)
    {
        var enemyPlayer = PlayersList.GetEnemy(username);
