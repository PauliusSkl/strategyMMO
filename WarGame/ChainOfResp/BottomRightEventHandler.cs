...
namespace WarGame.Forms.ChainOfResp;

public class BottomRightEventHandler : ShotEventHandler
{
    ...
    public override int HandleShotEvent(Type type, int coordX, int coordY)
    {
        if (coordX >= 250 && coordY >= 250)
        {
            ...
            {
                Debug.WriteLine("Bottom right bonus applied for MG: " + ShotBonus.Item2);
