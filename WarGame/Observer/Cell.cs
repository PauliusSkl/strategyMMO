...
{
    private GamePlayForm Form2 { get; set; }
    ...
    public Cell(Grid grid, GamePlayForm form2, string coordinates, int pictureAxisX, int pictureAxisY)
    {
        Grid = grid;
        Form2 = form2;
    ...
    public void CheckIfHit()
    {
        ...
        {
            IsHit = true;
            _ = Form2.AddShot(Coordinates, PictureAxisX, PictureAxisY);
        }
    }
